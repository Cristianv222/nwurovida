                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="post">
                                    ...
                                    <?php
                                    $ret = "SELECT tblstudents.StudentName, tblclasses.ClassName, tblclasses.Section FROM tblresult JOIN tblstudents ON tblresult.StudentId = tblstudents.StudentId JOIN tblsubjects ON tblsubjects.id = tblresult.SubjectId JOIN tblclasses ON tblclasses.id = tblstudents.ClassId WHERE tblstudents.StudentId = :stid LIMIT 1";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <select name="marks[]" class="form-control" required="required">
                                                        <option value="5" <?php if ($result->marks == "5") echo 'selected'; ?>>Sobresaliente</option>
                                                        <option value="4" <?php if ($result->marks == "4") echo 'selected'; ?>>Excelente</option>
                                                        <option value="3" <?php if ($result->marks == "3") echo 'selected'; ?>>Bueno</option>
                                                        <option value="2" <?php if ($result->marks == "2") echo 'selected'; ?>>Regular</option>
                                                        <option value="1" <?php if ($result->marks == "1") echo 'selected'; ?>>Malo</option>
                                                    </select>
                                                </div>
                                            </div>
                                        <?php }
