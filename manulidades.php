...
.header-txt h1 {
    ...
    font-size: 90px; /* Tamaño de fuente para pantallas grandes */
    margin-bottom: 10px;
    letter-spacing: 0;
    white-space: normal;
    text-align: left; /* O usar 'right' para mover a la derecha */
    margin-left: 40px;
}
...
@media (max-width: 768px) {
    ...
    .header-txt h1 {
        font-size: 50px; /* Cambia el tamaño de fuente para móviles */
