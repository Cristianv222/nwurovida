...
<header class="header_doulas">
    <!-- Remover o actualizar la siguiente línea si 'menu_nav.php' está en otra ubicación -->
...
<section class="about container">
    ...
    <div class="about-txt">
        <h2>Mujeres en estado de gestación</h2>
        <p>
            ...
            fortaleciendo la salud mental de ambos y ayudando a mitigar los efectos del estrés cognitivo.
        </p>
    </div>
</section>
...
<section class="pricing">
    <div class="plan">
        <h3>Plan Diario</h3>
        <p class="price"><span class="discount"></span> $1.33/Día</p>
