...
<header class="header">
    ...
    <section class="about container">
        ...
        <div class="about-txt">
        <h2>Público de 12 años en adelante</h2>
            <p>
            Este curso está diseñado para jóvenes que desean dar sus primeros 
            pasos en el mundo de la programación de manera divertida y accesible. 
            A través de actividades interactivas y proyectos prácticos, los estudiantes aprenderán 
            a pensar de forma lógica y a resolver problemas mientras exploran el mundo de la tecnología.
              <p>
    ...
    <main class="servicios">
        ...
        <div class="servicios-content container">
            ...
            <div class="servicio-1">
                ...
                <p>
                Este módulo establece las bases para entender cómo funciona la programación. 
                Los estudiantes aprenderán sobre los conceptos fundamentales, como algoritmos, 
                variables, y estructuras de control (condicionales y bucles), todo en un lenguaje de fácil 
                comprensión. Mediante ejercicios prácticos y juegos de lógica, los alumnos se familiarizarán
                 con el pensamiento computacional y la resolución de problemas, lo que les ayudará 
                 a comprender cómo se crean los programas de software.
                </p>
            </div>
            ...
            <div class="servicio-1">
                ...
                <p>
                En este módulo, los estudiantes descubrirán el emocionante mundo
                 de la inteligencia artificial (IA). Aprenderán los conceptos básicos de la IA,
                  cómo se usa en la vida diaria (como en asistentes virtuales y reconocimiento facial) 
                  y comprenderán las diferencias entre inteligencia artificial, aprendizaje automático 
                  y redes neuronales. Mediante actividades interactivas, explorarán cómo los algoritmos
                   de IA permiten que las computadoras "aprendan" a partir de datos, además de entender
                    sus aplicaciones éticas y responsables en el mundo actual.
                </p>
            </div>
            ...
            <div class="servicio-1">
                ...
                <p>
                Este módulo introduce a los estudiantes en el diseño y desarrollo de sitios web.
                 Aprenderán los principios básicos de HTML (para el contenido), CSS (para el estilo) 
                 y JavaScript (para la interactividad), lo que les permitirá crear sus propias páginas web 
                 desde cero. Al finalizar este módulo, los estudiantes habrán desarrollado una página web
                  simple pero funcional, aplicando diseño, estructura y un poco de interactividad,
                   para que puedan compartir su trabajo en línea.
                </p>
            </div>

            <div class="servicio-1">
                <i class="fa-solid fa-brain"></i>
                <h3>Creación de juegos interactivos en Pyton  </h3>
                <p>
                Python es uno de los lenguajes de programación más populares y accesibles
                 para los principiantes. En este módulo, los estudiantes aprenderán a crear juegos 
                 interactivos en Python usando bibliotecas como Pygame. Empezarán con conceptos básicos,
                  como crear personajes y escenarios, y avanzarán a funciones más complejas, como el manejo
                   de eventos y la lógica de los juegos. Al finalizar, los estudiantes tendrán un juego propio
                    que podrán jugar y mejorar, potenciando tanto su creatividad como sus habilidades
                     de programación.
                </p>
            </div>
        </div>
...
@media (max-width: 768px) {
    .about-txt h2 {
        ...
        margin-left: 0; /* Ajuste para centrar en móviles */
        text-align: center;
    }
